...
<title>SLEEK SILHOUTTES -  Feedback</title>
<link
...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary">
		<div class="container-fluid">
			...
			<div class="mx-auto">
				<h3>
					<strong>SLEEK SILHOUTTES</strong>
				</h3>
			</div>
			<!-- Back button -->
			<div class="d-flex">
	...
	<section class="about-us">
		<div class="container">
			<h2>About Us</h2>
			<p>Welcome to Sleek Silhouettes: Your Premier Boutique
				Destination</p>
			<p>At Sleek Silhouettes, we are committed to enhancing your
				boutique shopping experience with our exclusive online platform. Our
				mission is to connect you with exquisite collections and the finest
				materials, ensuring you receive unparalleled style and satisfaction
				every time.</p>
		</div>
	</section>
	...
	<footer class="bg-dark text-white pt-5 pb-3">
		<div class="container">
			<div class="row">
				<!-- Company Information -->
				<div class="col-md-3">
					<h5 class="text-uppercase">SLEEK SILHOUTTES</h5>
			...
			<div class="text-center mt-4">
				<p class="mb-0">&copy; 2024 SLEEK SILHOUTTES. All rights
					reserved.</p>
			</div>
		</div>
	</footer>
